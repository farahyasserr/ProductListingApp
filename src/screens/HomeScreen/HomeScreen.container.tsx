...
import { deleteProduct, setProducts } from '../../store/reducers/ProductsSliceReducer';
...
function HomeScreen() {
  ...
  return <HomeScreenView products={products} isLoading={isLoading} addToCartHandler={addToCartHandler} deleteProductHandler={deleteProductHandler} pressItemhandler={pressItemhandler} />;
}
